...
SIGNAL \last|orxyxzyz|Y~0_combout\ : std_logic;
...
\last|orxyxzyz|Y~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \last|orxyxzyz|Y~0_combout\ = (\last|y|Y~combout\ & ((\Y[0]~input_o\) # (\dm2|orb|Y~1_combout\ $ (\Y[2]~input_o\)))) # (!\last|y|Y~combout\ & (\Y[0]~input_o\ & (\dm2|orb|Y~1_combout\ $ (\Y[2]~input_o\))))
...
PORT MAP (
	...
	datac => \Y[2]~input_o\,
	datad => \Y[0]~input_o\,
	combout => \last|orxyxzyz|Y~0_combout\);
